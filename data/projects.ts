...
export const projects: Project[] = [
    ...
    },
    {
        id: 'pentix',
        name: 'Pentix',
        description: 'Pentix is a modern, full-stack Reputation Management platform designed for local businesses (restaurants, dental clinics, salons, etc.). It empowers business owners to take total control of their digital presence by filtering negative feedback and maximizing positive Google reviews through AI-driven automation.',
        coverImage: '/projects/pentix.png',
        techStack: ['Next.js', 'SCSS / Sass', 'Supabase'],
